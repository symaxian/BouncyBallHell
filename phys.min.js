var star,$;
(function(){function s(a,c,f){this.x=a;this.y=c;this.setType(f)}function t(){this.bodies=[]}s.prototype={type:null,canMove:!0,cell:null,x:0,y:0,vx:0,vy:0,fx:0,fy:0,ax:0,ay:0,applyForce:function(a){this.ax=this.fx/this.mass;this.ay=this.fy/this.mass;this.vx+=this.ax*a;this.vy+=this.ay*a;this.x+=this.vx*a;this.y+=this.vy*a;this.fy=this.fx=0},setType:function(a){this.type=a;this.radius=star.classes[a].radius;this.mass=star.classes[a].mass;this.threshold=star.classes[a].threshold}};t.prototype={bodies:null,
...
drawGrid:!1,drawCellMass:!1,drawCellCenterOfMass:!1,particleDrawSizeMultiplier:0.75,classes:[{},{color:"Black",radius:2,mass:10,threshold:1E6,count:0},{color:"Purple",radius:3,mass:20,threshold:3E6,count:0},{color:"Blue",radius:4,mass:30,threshold:8E6,count:0},{color:"Green",radius:5,mass:40,threshold:12E6,count:0},{color:"Yellow",radius:6,mass:50,threshold:25E6,count:0},{color:"Orange",radius:7,mass:60,threshold:36E6,count:0},{color:"Red",radius:8,mass:70,threshold:49E6,count:0},{color:"Pink",radius:10,
mass:-1E4}],init:function(){star.canvas=document.getElementById("canvas");star.setGridCellSize(12E3);document.body.onresize=star.updateCanvasSize;star.updateCanvasSize();star.ctx=star.canvas.getContext("2d");star.canvas.onmousedown=function(a){var c=(star.canvas.offsetWidth-star.width)/2;a=new s(a.clientX-star.canvas.offsetLeft-c,a.clientY-star.canvas.offsetTop-c,8);a.canMove=!1;star.bodies.push(a)};star.canvas.onmouseup=function(){star.bodies.pop()};star.ui.init();star.restart()},updateCanvasSize:function(){var a=
